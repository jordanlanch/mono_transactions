defmodule TransactionsMonoWeb.UserAuthTest do
  use TransactionsMonoWeb.ConnCase, async: true

  alias TransactionsMono.Accounts
  alias TransactionsMonoWeb.UserAuth
  import TransactionsMono.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TransactionsMonoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TransactionsMonoWeb.Endpoint.subscribe(live_socket_id)
